...
|---|---|---|
| 0 | Foundations | ~0.5 weeks |
| 1 | First Agent (scratch + SDK) | ~6 weeks |
| 2 | Real Architecture (LangGraph + Mastra) | ~9 weeks |
| 3 | Build the Harness | ~9 weeks |
| 4 | Evals & Regression | ~11 weeks |
| 5 | Production Hardening | Ongoing |

## Progress

See `MY_ROADMAP.md` for current phase and next action.
